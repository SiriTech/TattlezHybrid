...
define(['../modules/services'], function (services) {
	...
	services.factory('configSrvc', function () {
		return {
			...
			serverURL:"http://tattlez-44952.onmodulus.net",
            ...
            "earth_asia", "volcano", "milky_way", "partly_sunny", "octocat", "squirrel","sunny", "umbrella", "cloud",
                "snowflake", "snowman", "zap", "cyclone", "foggy", "ocean"],
            emoticons3 : ["bamboo", "gift_heart", "dolls", "school_satchel", "mortar_board", "flags",
            ...
            emoticons4 : ["house", "house_with_garden", "school", "office", "post_office", "hospital",
            ...
            "gb", "uk", "de"],
            emoticons5 : ["one", "two", "three", "four", "five", "six", "seven",
